...
import hr.algebra.iamuprojekt.task.ToDoItem
import java.util.*
...
class ItemActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val recycleViewItem: RecyclerView = findViewById(R.id.rv_item)
        recycleViewItem.layoutManager = LinearLayoutManager(this)

        val floatingButtonItem: FloatingActionButton = findViewById(R.id.fab_item)
        floatingButtonItem.setOnClickListener {
        ...
        touchHelper?.attachToRecyclerView(recycleViewItem)
